...
it("renders correctly", () => {
  const tree = renderer.create(<InputManager />).toJSON();
...
describe("<InputManager />", () => {
  ...
  describe("validateField()", () => {
    ...
    it("should set amountValid to false when a amount value given exceeds 10000000000000", () => {
      ...
      expect(inputManager.setState.mock.calls[0][0].amount).toBe(
        10000000000000
      );
      expect(inputManager.setState.mock.calls[1][0].formErrors.amount).toBe(
