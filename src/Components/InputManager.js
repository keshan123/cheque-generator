...
class InputManager extends React.Component {
        ...
        if (!value) {
          ...
          if (/[a-zA-Z]/.test(value)) {
            ...
            if (!validatedMoment) {
              ...
              // splits date into individual characters for cheque
  ...
  validateForm = () => {
    // if all three inputs are valid then form becomes valid
    this.setState({
      formValid:
